<template>
    <div class="billing">
        <div class="billing__form">
            <div class="header">
                <h2>Buyer Info</h2>
                <span>Already have an account?<nuxt-link :to="{name :'auth'}"> login</nuxt-link></span>
            </div>
            <form>
                <v-text-field
                outlined
...
<script>
  export default {
    data: () => ({
      cities:[{id:1 , name: "cairo"} , {id:2 , name: "alexandria"} ],
      rules: [
